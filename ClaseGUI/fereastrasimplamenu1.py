...
'''
-tt pastreaza identarea in fila de text 
...
'''
        ...
        # HELP > About > Program Help
        subMenuHelp = Menu(fileMenu)
        subMenuHelp.add_command(label="About", command=self.aboutInfo)
        menubar.add_cascade(label="Help", menu=subMenuHelp, underline=0)

    def onExit(self):
        self.parent.quit()
        
    def aboutInfo(self):
        tkMessageBox.showinfo("Salut!", "Acest program a fost scris de\n Mihai Cornel.\n Versiunea: 16.09.2014")
